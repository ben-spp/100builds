        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-8 mb-12">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-3 mb-3">
                  ...
                  <div className="flex lg:hidden gap-2 flex-shrink-0 ml-auto">
                    ...
                    <button
                      onClick={onLike}
                      className="flex items-center justify-center w-10 h-10 rounded-full bg-transparent border border-border hover:bg-surface-1 text-text-primary transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center w-10 h-10 rounded-full bg-text-primary hover:bg-text-secondary text-surface-0 transition-colors"
                    >
            ...
            <div className="hidden lg:flex gap-3">
              ...
              <button
                onClick={onLike}
                className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-transparent border border-border hover:bg-surface-1 text-text-primary transition-colors"
              >
              ...
              <button
                onClick={onContactClick}
                className="px-6 py-3 rounded-xl bg-text-primary hover:bg-text-secondary text-surface-0 font-semibold transition-colors"
              >
                Get in touch
              </button>
            </div>
